...
const Queries: FC<contactProps> = ({ paymentData }) => {
  ...
  const handleCall = () => {
    window.open(`tel:${invoiceData?.merchant_mobile || paymentData?.merchant_mobile}`, "_self");
  };

  const handleEmail = () => {
    window.open(`mailto:${invoiceData?.merchant_email || paymentData?.merchant_email}`, "_self");
  };
        ...
        <CardContent>
          <div className="flex flex-col gap-2 p-2">
            <p className="text-[12px] ml-2">
              ...
              <span className="font-bold"> {invoiceData?.merchnat_name || paymentData?.merchant_name}</span>
            </p>
            <div className="flex flex-wrap gap-2 ">
              <div className="flex gap-2" onClick={handleCall}>
                <img
                  ...
                  height={20}
                />
                <p>{invoiceData?.merchant_mobile || paymentData?.merchant_mobile}</p>
              </div>
              <div className="flex gap-2 " onClick={handleEmail}>
                <img
                  ...
                  height={20}
                />
                <p>{invoiceData?.merchant_email || paymentData?.merchant_email}</p>
              </div>
            </div>
          </div>
        </CardContent>
